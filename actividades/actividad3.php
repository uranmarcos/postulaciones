                ...
                consultarActividad () {
                    ...
                    .then(function(response){ 
                        if (response.data.error) {
                            ...
                            let habilitado = response.data.resultado[0].habilitado3;
                            if (habilitado == 0) {
                                window.location.href = '../menu.php'; 
                            } else {
                                app.comenzarActividad();
                                if (response.data.resultado[0].resultado3 != "-") {
                                    let respuestas = JSON.parse(response.data.resultado[0].resultado3);
                                    if (respuestas != "-") {
